  ...
  addTag: function(tag) {
    ...
    if (this.props.autocomplete) {
      ...
      this.props.autocomplete === true && possibleMatches.length)  {
        tag = possibleMatches.find((s) => { return s.toLowerCase() === tag.toLowerCase() });
        if (!tag) {
  ...
  render: function() {
    ...
    const tagInput =  !this.props.readOnly ? (
      <div className={this.state.classNames.tagInput}>
        ...
        <div className={this.state.classNames.submit}
          onClick={this.props.emptyEnter}>{this.props.btnText}</div>
